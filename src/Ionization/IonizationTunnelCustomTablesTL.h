#ifndef IONIZATIONTUNNELCUSTOMTABLESTL_H
#define IONIZATIONTUNNELCUSTOMTABLESTL_H
...
class IonizationTunnelCustomTablesTL : public Ionization
{

public:
    //! Constructor for IonizationTunnelCustomTablesTL: with no input argument
    IonizationTunnelCustomTablesTL( Params &params, Species *species );
