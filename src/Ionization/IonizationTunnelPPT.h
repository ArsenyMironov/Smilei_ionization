#ifndef IONIZATIONTUNNELPPT_H
#define IONIZATIONTUNNELPPT_H
...
class IonizationTunnelPPT : public Ionization
{

public:
    //! Constructor for IonizationTunnelPPT: with no input argument
    IonizationTunnelPPT( Params &params, Species *species );
