...
// Gets the principal atomic number of a given ion
int IonizationTables::principal_atomic_number( int atomic_number, int Zstar )
{
    return ( int )principalQuantumNumber[( atomic_number*( atomic_number-1 ) )/2 + Zstar];
}
