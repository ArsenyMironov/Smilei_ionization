...
IonizationTunnelFullADK::IonizationTunnelFullADK( Params &params, Species *species ) : Ionization( params, species )
{
...
void IonizationTunnelFullADK::operator()( Particles *particles, unsigned int ipart_min, unsigned int ipart_max, vector<double> *Epart, Patch *patch, Projector *Proj, int ipart_ref )
{
