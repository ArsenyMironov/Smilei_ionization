...
IonizationTunnelCustomCoeff::IonizationTunnelCustomCoeff( Params &params, Species *species ) : Ionization( params, species )
{
...
void IonizationTunnelCustomCoeff::operator()( Particles *particles, unsigned int ipart_min, unsigned int ipart_max, vector<double> *Epart, Patch *patch, Projector *Proj, int ipart_ref )
{
