#ifndef IONIZATIONTUNNELCUSTOMCOEFFTL_H
#define IONIZATIONTUNNELCUSTOMCOEFFTL_H
...
class IonizationTunnelCustomCoeffTL : public Ionization
{

public:
    //! Constructor for IonizationTunnelCustomCoeffTL: with no input argument
    IonizationTunnelCustomCoeffTL( Params &params, Species *species );
